...
{
    internal class TCPPacketReCreator
    {
            ...
            while (pointer < bytes)
            {
                ...
                switch (data[0])
                {
                    ...
                    case 170:
                        ...
                        Debug.WriteLine("File: " + file.File.FileSize + " " + file.File.FileName + " " +
                                        file.File.LastModyfiedDate);
                        packets.Add(file);
                        break;
                    case 160:
                    ...
                    case 0:
                        ...
                        break;
                    default:
                        throw new Exception("Shit just happened " + data[0]);
                }
            }
            return packets;
        }
